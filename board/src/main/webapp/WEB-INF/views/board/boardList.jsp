...
<script type="text/javascript">
	...
	/** 게시판 - 상세 페이지 이동 */
	function goBoardDetail(boardSeq, secYn) {		
			...
			if(listLen >  0){
				...
				for(var a=0; a<listLen; a++){
					...
					if(boardWriter == "관리자") {
						...
						str += "<td style='color:red; font-weight : bold'>"+ boardSeq +"</td>";
						
						
						str += "<td style='color:red; font-weight : bold; cursor:pointer' onclick='javascript:goBoardDetail(" + boardSeq + "," + secYn + ");'>";
						...
						str += "<td style='color:red; font-weight : bold'>"+ boardHits +"</td>";
						str += "<td style='color:red; font-weight : bold'>"+ boardWriter +"</td>";	
						str += "<td style='color:red; font-weight : bold'>"+ insDate +"</td>";	
						str += "</tr>";
						...
						str += "<td onclick='javascript:goBoardDetail("+ boardSeq + "," + secYn + ");' style='cursor:pointer'>";
	...
	<div id="container">
		<div class="inner">		
			...
			<div class="btn_right mt15">
				<button type="button" class="btn black mr5" onclick="javascript:goBoardWrite();" style='cursor:pointer'>작성하기</button>
			</div>
		</div>
