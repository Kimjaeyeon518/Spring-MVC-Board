...
<script type="text/javascript">
	...
	function goBoardUpdateAction(){
		
		location.href = "/board/boardUpdateAction?boardSeq="+ ${boardSeq};
	}
	...
	<div id="container">
		<div class="inner">	
			...
			<div class="btn_right mt15">
				...
				<button type="button" class="btn black mr5" onclick="javascript:goBoardUpdateAction();">수정하기</button>
