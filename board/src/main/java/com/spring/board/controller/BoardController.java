...
public class BoardController {
	...
	/** 게시판 - 상세 조회 */
	@RequestMapping(value = "/getBoardPw")
	@ResponseBody
	public BoardDto getBoardPw(HttpServletRequest request, HttpServletResponse response, BoardForm boardForm) throws Exception {

		BoardDto boardDto = boardService.getBoardPw(boardForm);
	...
	@RequestMapping(value = "/boardUpdateAction")
	public String boardUpdateAction(HttpServletRequest request, HttpServletResponse response) throws Exception {
